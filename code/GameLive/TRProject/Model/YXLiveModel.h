...
@class YXLiveRecommendModel,YXLiveRecommendDataModel,YXLiveLinkObjectModel;
@interface YXLiveModel : NSObject
@property (nonatomic, strong) YXLiveRecommendModel *recommend;

@property (nonatomic, strong) NSArray<YXLiveLinkObjectModel *> *data;
...
@interface YXLiveRecommendModel : NSObject

@property (nonatomic, copy) NSString *name;

@property (nonatomic, copy) NSString *icon;

@property (nonatomic, strong) NSArray<YXLiveRecommendDataModel *> *data;

@end

@interface YXLiveRecommendDataModel : NSObject
//id -> ID
...
@property (nonatomic, strong) YXLiveLinkObjectModel *link_object;
...
@interface YXLiveLinkObjectModel : NSObject
//new_start_time -> nStartTime
@property (nonatomic, copy) NSString *nStartTime;
